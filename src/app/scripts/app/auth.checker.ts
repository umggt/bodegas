...
//interface IDemo extends OidcTokenManager
...
function checkSessionState() {
    mgr.oidcClient.loadMetadataAsync().then(function (meta) {
        if (meta.check_session_iframe && mgr.session_state) {
            (document.getElementById("rp") as HTMLIFrameElement).src = "check_session.html#" +
            ...
            (document.getElementById("rp") as HTMLIFrameElement).src = "about:blank";
        }
    });
}
